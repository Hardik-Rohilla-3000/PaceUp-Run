    ...
    <span><strong>Timeline:</strong> {activeEvent.timeline}</span>
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4 border-t border-slate-100 dark:border-slate-800">
            <button
              ...
              className="flex-1 font-display font-bold text-center uppercase tracking-wider py-3.5 rounded-xl bg-gradient-to-r from-red-700 to-gray-800  text-white shadow-lg  transition-all duration-200 cursor-pointer"
            >
