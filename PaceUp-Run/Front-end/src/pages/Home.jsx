      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-r from-primary-navy to-[#040D1D] rounded-3xl p-8 md:p-16 border border-slate-800/80 shadow-2xl relative overflow-hidden text-center space-y-6">
          ...
          <div className="pt-4 flex flex-col sm:flex-row justify-center gap-4">
            <button
              // onClick={() => navigate('/register')}
              className="font-display font-bold uppercase tracking-wider px-10 py-4 rounded-xl bg-gradient-to-r from-red-700 to-gray-800  text-white shadow-xl stransform hover:-translate-y-0.5 transition-all duration-200 cursor-pointer"
            >
